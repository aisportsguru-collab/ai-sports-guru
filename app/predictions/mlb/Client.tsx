      ...
      <div className="mt-4 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-3 py-2 rounded border ${meta.page > 1 ? "border-gray-600 hover:bg-gray-800" : "border-gray-800 text-gray-500 cursor-not-allowed"}`}
          >
            Prev
          </button>
          ...
          <button
            ...
            className={`px-3 py-2 rounded border ${meta.page < meta.totalPages ? "border-gray-600 hover:bg-gray-800" : "border-gray-800 text-gray-500 cursor-not-allowed"}`}
          >
            Next
          </button>
        </div>
